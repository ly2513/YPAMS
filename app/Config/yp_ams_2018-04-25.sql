...
# Database: yp_ams
# Generation Time: 2018-04-24 23:43:06 +0000
# ************************************************************
...
INSERT INTO `ams_sys_user` (`id`, `pid`, `name`, `nickname`, `phone`, `password`, `head_img`, `status`, `token`, `create_time`, `update_time`, `login_time`, `create_by`, `update_by`, `is_delete`)
VALUES
	(1,0,'admin','dylan.li','18518178485','$2y$10$w4xL7hzI1dIATcSWfcZlTerFg3wjeomZGfSqHTA/mbvdG/JHqjWsq','Static/images/head.png',1,'',0,1524500320,0,0,1,0),
	(2,0,'张三','ly2513','','$2y$10$dintxct1gqOauJ0trV543OxMLnE3djt5hrwc/XPUeYye5eoopbY9G','Static/images/head.png',1,'',1524418445,1524418445,0,1,1,0);
